...
<center><h1><b style="color:black">Delete Customer</b></h1>
<table>
...
<tr><td><label><b>Customer SSNID</b></label></td>
   ...
   <tr><td><label><b>Customer SSNID</b></label></td>
    ...
    <td><input style="width:6cm;" type="text"  name="custName"  value="<%=c.getCustName()%>"readonly></td></tr>
    
    
   <tr><td> <label><b>Age</b></label></td>
   <td> <input style="width:6cm;" type="text" name="age" value="<%=c.getAge()%>"readonly></td></tr>
  
 <tr><td> <label><b>Address Line1</b></label></td>
   <td> <input style="width:6cm;" type="text" name="add_line1" value="<%=c.getAdd_line1()%>"readonly></td></tr>
  
  <tr><td><label><b>Address Line2</b></label></td>
   <td> <input style="width:6cm;" type="text" name="add_line2" value="<%=c.getAdd_line1()%>"readonly></td></tr>
   
  <tr><td> <label><b>City</b></label></td>
   <td> <input style="width:6cm;" type="text" name="city" value="<%=c.getCity()%>"readonly></td></tr>
     
   <tr> <td> <label><b>State</b></label></td>
   <td> <input style="width:6cm;" type="text" name="state"value="<%=c.getState()%>" readonly></td></tr>
...
<!-- <tr><td> <label><b>Pincode</b></label></td>
   <td> <input style="width: 220px;height:1cm;;padding:12px 10px; border: 2px solid #ccc;
    box-sizing:border-box;" type="pincode" placeholder="Enter Pincode" id="pin" name="pincode" ></td></tr> -->
     ...
     <button type="submit" class="cancelbtn" name="action"  value="delete" onclick="return validateForm()">Delete</button>&nbsp;&nbsp;
