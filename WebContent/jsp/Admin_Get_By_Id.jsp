...
<body>
	...
	<div>
		<img alt="logo" src="logo1.png" style="width: 250px; height: 100px;">
	</div>
	<div>
		<ul>
			...
			<li><a href=""><b>Welcome <%=request.getSession().getAttribute("username")%>
						(Admin)
				</b></a></li>
	...
	<form action="<%=request.getContextPath()%>/CustomerController"
		...
		<center>
			<h1>
				<b style="color: #2a5763">Get By ID</b>
			</h1>
		</center>
		<div align="center">
		...
		<div align="center">
			<button type="submit" class="button" name="action" value="ser_update"
				onclick="    ">Submit</button>
			<button type="button" class="button" name="action"
				onclick="window.location.href='Admin_Home.jsp'">Cancel</button>
